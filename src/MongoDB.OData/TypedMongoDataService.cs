...
namespace MongoDB.OData
{
    public abstract class TypedMongoDataService : DataService<MongoServer>, IServiceProvider
    {
        ...
        public object GetService(Type serviceType)
        {
            ...
            else if (serviceType == typeof(IDataServiceUpdateProvider) || serviceType == typeof(IDataServiceUpdateProvider2))
            {
        ...
        private TypedMongoDataServiceUpdateProvider GetUpdateProvider()
        {
            return new TypedMongoDataServiceUpdateProvider(GetMetadataProvider(), GetQueryProvider());
        }
